...
// (DO NOT EDIT: machine generated header) 'REST.Backend.PushTypes.pas' rev: 35.00 (Windows)
...
public:
	...
	public:
		...
		{
		public:
			#define TPushData_TGCM_TNames_Action L"action"
			
			#define TPushData_TGCM_TNames_Msg L"msg"
			
			#define TPushData_TGCM_TNames_Message L"message"
			
			#define TPushData_TGCM_TNames_Title L"title"
