...
// (DO NOT EDIT: machine generated header) 'dxSkinPumpkin.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinPumpkinRS28.bpi"
#else
#pragma link "dxSkinPumpkinRS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinPumpkinPainter() { }
