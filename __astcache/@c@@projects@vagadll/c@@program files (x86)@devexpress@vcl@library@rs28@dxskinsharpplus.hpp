...
// (DO NOT EDIT: machine generated header) 'dxSkinSharpPlus.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinSharpPlusRS28.bpi"
#else
#pragma link "dxSkinSharpPlusRS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinSharpPlusPainter() { }
