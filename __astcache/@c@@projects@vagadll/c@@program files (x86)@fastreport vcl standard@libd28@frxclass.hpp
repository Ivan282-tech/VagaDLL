...
enum DECLSPEC_DENUM Frxclass__3 : unsigned char { csFrxDesigning, csFrxWriting, csFrxSerializeToDict };

typedef System::Set<Frxclass__3, Frxclass__3::csFrxDesigning, Frxclass__3::csFrxSerializeToDict> TfrxComponentState;
...
__interface  INTERFACE_UUID("{63ABB456-F4C9-49DA-ADA2-E3ABC7125B15}") IfrxAggregateObject  : public System::IInterface 
{
	...
	virtual System::UnicodeString __fastcall GetExpressionDelimeters() = 0 ;
...
private:
	...
	bool __fastcall GetKeepAspectRatio();
	void __fastcall SetKeepAspectRatio(const bool Value);
...
protected:
	void __fastcall SetCachedGraphic(Frxbasegraphicstypes::_di_IfrxCachedGraphic cGraphic);
...
__published:
	...
	__property bool KeepAspectRatio = {read=GetKeepAspectRatio, write=SetKeepAspectRatio, default=1};
	__property Vcl::Graphics::TPicture* Picture = {read=GetPicture, write=SetPicture, stored=FIsPictureStored};
	__property bool Stretched = {read=GetStretched, write=SetStretched, default=1};
	__property TagStr = {default=0};
	__property URL = {default=0};
