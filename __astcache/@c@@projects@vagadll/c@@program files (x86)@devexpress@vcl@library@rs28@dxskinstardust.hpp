...
// (DO NOT EDIT: machine generated header) 'dxSkinStardust.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinStardustRS28.bpi"
#else
#pragma link "dxSkinStardustRS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinStardustPainter() { }
