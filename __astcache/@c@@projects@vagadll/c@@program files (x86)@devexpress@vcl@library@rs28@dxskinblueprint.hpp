...
// (DO NOT EDIT: machine generated header) 'dxSkinBlueprint.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinBlueprintRS28.bpi"
#else
#pragma link "dxSkinBlueprintRS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinBlueprintPainter() { }
