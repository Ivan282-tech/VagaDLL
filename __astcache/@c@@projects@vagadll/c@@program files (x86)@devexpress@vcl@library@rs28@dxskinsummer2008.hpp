...
// (DO NOT EDIT: machine generated header) 'dxSkinSummer2008.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinSummer2008RS28.bpi"
#else
#pragma link "dxSkinSummer2008RS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinSummer2008Painter() { }
