...
class DELPHICLASS TRESTHTTPExt;
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
#pragma pack(push,4)
#endif /* not _WIN64 */
...
{
	typedef TRESTHTTP inherited;
	
private:
	System::UnicodeString FClientCertificatePassword;
	System::UnicodeString FClientCertificatePath;
	System::Classes::TStream* FClientCertificateStream;
	void __fastcall SetClientCertificatePath(const System::UnicodeString AValue);
	void __fastcall SetClientCertificateStream(System::Classes::TStream* const AValue);
	
public:
	__property System::Classes::TStream* ClientCertificateStream = {read=FClientCertificateStream, write=SetClientCertificateStream};
	__property System::UnicodeString ClientCertificatePath = {read=FClientCertificatePath, write=SetClientCertificatePath};
	__property System::UnicodeString ClientCertificatePassword = {read=FClientCertificatePassword, write=FClientCertificatePassword};
public:
	/* TRESTHTTP.Create */ inline __fastcall TRESTHTTPExt() : TRESTHTTP() { }
	/* TRESTHTTP.Destroy */ inline __fastcall virtual ~TRESTHTTPExt() { }
