...
// (DO NOT EDIT: machine generated header) 'REST.Backend.ServiceTypes.pas' rev: 35.00 (Windows)
...
{
public:
	#define TBackendQueryServiceNames_Storage L"Storage"
	
	#define TBackendQueryServiceNames_Users L"Users"
	
	#define TBackendQueryServiceNames_Installations L"Installations"
	
	#define TBackendQueryServiceNames_Groups L"Groups"
	
	#define TBackendQueryServiceNames_Modules L"Edgemodules"
	
	#define TBackendQueryServiceNames_ModulesResources L"Edgeresources"
	
	#define TBackendQueryServiceNames_Files L"Files"
...
__interface  INTERFACE_UUID("{1F54E3F6-693D-4A25-AC00-7CFFC99D6632}") IBackendQueryApi  : public IBackendGetMetaFactory 
{
	...
	virtual void __fastcall Query(const Rest::Backend::Metatypes::TBackendClassValue AClass, const System::UnicodeString *AQuery, const int AQuery_High, System::Json::TJSONArray* const AJSONArray, /* out */ System::DynamicArray<Rest::Backend::Metatypes::TBackendEntityValue> &AObjects) = 0 /* overload */;
...
private:
	...
	void __fastcall Query(const Rest::Backend::Metatypes::TBackendClassValue AClass, const System::UnicodeString *AQuery, const int AQuery_High, System::Json::TJSONArray* const AJSONArray, /* out */ System::DynamicArray<Rest::Backend::Metatypes::TBackendEntityValue> &AMetaArray)/* overload */;
...
private:
	...
	void __fastcall QueryObjects(const Rest::Backend::Metatypes::TBackendClassValue AClass, const System::UnicodeString *AQuery, const int AQuery_High, System::Json::TJSONArray* const AJSONArray, /* out */ System::DynamicArray<Rest::Backend::Metatypes::TBackendEntityValue> &AMetaArray)/* overload */;
...
#ifndef _WIN64
	virtual void __fastcall QueryUsers(const System::UnicodeString *AQuery, const int AQuery_High, System::Json::TJSONArray* const AJSONArray, /* out */ System::DynamicArray<Rest::Backend::Metatypes::TBackendEntityValue> &AMetaArray) = 0 /* overload */;
#else /* _WIN64 */
...
{
#ifndef _WIN64
	virtual void __fastcall AddUsers(const System::UnicodeString AGroupName, const System::DynamicArray<System::UnicodeString> AUsers, /* out */ Rest::Backend::Metatypes::TBackendEntityValue &AUpdatedObject) = 0 ;
