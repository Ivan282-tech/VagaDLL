...
// (DO NOT EDIT: machine generated header) 'dxSkinDarkRoom.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinDarkRoomRS28.bpi"
#else
#pragma link "dxSkinDarkRoomRS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinDarkroomPainter() { }
