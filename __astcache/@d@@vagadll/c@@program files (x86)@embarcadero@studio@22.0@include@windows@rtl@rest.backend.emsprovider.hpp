...
// (DO NOT EDIT: machine generated header) 'REST.Backend.EMSProvider.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#pragma link "REST.Backend.EMSProvider"
...
public:
	#define TCustomEMSProvider_ProviderID L"EMS"
