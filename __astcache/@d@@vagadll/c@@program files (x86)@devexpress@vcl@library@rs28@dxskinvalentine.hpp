...
// (DO NOT EDIT: machine generated header) 'dxSkinValentine.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinValentineRS28.bpi"
#else
#pragma link "dxSkinValentineRS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinValentinePainter() { }
