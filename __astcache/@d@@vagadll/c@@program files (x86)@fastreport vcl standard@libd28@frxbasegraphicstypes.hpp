...
enum DECLSPEC_DENUM TfrxGraphicDrawProp : unsigned char { fgdAutoSize, fgdCenter, fgdKeepAspectRatio, fgdStretch, fgdTransparent, fgdClip, fgdDefaultMaskColor };

typedef System::Set<TfrxGraphicDrawProp, TfrxGraphicDrawProp::fgdAutoSize, TfrxGraphicDrawProp::fgdDefaultMaskColor> TfrxGraphicDrawProps;
...
__interface  INTERFACE_UUID("{1E87267F-436A-4BFF-A6E9-0D03DD69F56C}") IfrxCachedView  : public System::IInterface 
{
	...
	virtual void __fastcall SetCachedGraphic(_di_IfrxCachedGraphic cGraphic) = 0 ;
