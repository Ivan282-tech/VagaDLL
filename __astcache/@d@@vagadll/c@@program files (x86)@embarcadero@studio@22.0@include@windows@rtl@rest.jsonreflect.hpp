...
// (DO NOT EDIT: machine generated header) 'REST.JsonReflect.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TListTFieldsEditor;
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
#pragma pack(push,4)
#endif /* not _WIN64 */
...
#ifndef _WIN64
	__classmethod System::Rtti::TRttiType* __fastcall ObjectType(System::Rtti::TRttiContext Ctx, System::UnicodeString TypeName);
#else /* _WIN64 */
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TListTFieldsEditor : public System::TObject
{
	typedef System::TObject inherited;
	
	
private:
	class DELPHICLASS TListCvt;
	class PASCALIMPLEMENTATION TListCvt : public System::Generics::Collections::TEnumerable__1<int>
	{
		typedef System::Generics::Collections::TEnumerable__1<int> inherited;
		
	private:
		System::Generics::Collections::TListHelper FListHelper;
	public:
		/* {System_Generics_Collections}TEnumerable<System_Integer>.Destroy */ inline __fastcall virtual ~TListCvt() { }
		
	public:
		/* TObject.Create */ inline __fastcall TListCvt() : System::Generics::Collections::TEnumerable__1<int>() { }
...
public:
#ifndef _WIN64
	__fastcall TListTFieldsEditor(const System::Rtti::TRttiContext ARTTICtx);
#else /* _WIN64 */
	__fastcall TListTFieldsEditor(const System::Rtti::TRttiContext &ARTTICtx);
#endif /* _WIN64 */
	static bool __fastcall ShouldEdit(System::TObject* Data);
	...
	bool __fastcall ShouldPrePopulate(System::TObject* Data, System::Rtti::TRttiField* rttiField);
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TListTFieldsEditor() { }
