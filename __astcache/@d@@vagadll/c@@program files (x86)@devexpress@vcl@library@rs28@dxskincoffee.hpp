...
// (DO NOT EDIT: machine generated header) 'dxSkinCoffee.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#ifdef USEPACKAGES
#pragma link "dxSkinCoffeeRS28.bpi"
#else
#pragma link "dxSkinCoffeeRS28.lib"
#endif
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinCoffeePainter() { }
